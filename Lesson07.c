...
* \brief           Ouvre une simple fenêtre Windows et dessine un cube avec OpenGL. Le cube est généré avec un fichier BITMAP en texture mapping.
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!NeHeLoadBitmap3("../../Data/Crate.bmp", texture))		// Load The Bitmap
		return FALSE;
